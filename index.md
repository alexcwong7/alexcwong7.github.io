...
<div class="w3-top">
  <div class="w3-bar w3-dark-grey w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide w3-xxlarge w3-margin-left logo">A<span class="red">W</span></a>
    ...
    <div class="w3-right w3-hide-small">
	  ...
	  <a href="resources/Alex%20Wong%20Resume%202020.pdf" download="Alex Wong Resume" class="w3-bar-item w3-button"><i class="fas fa-download"></i> RESUME</a>
    </div>
...
<header class="w3-display-container" id="home">
  <div class="w3-display-middle w3-text-white" style="padding:48px">
    <span class="w3-jumbo bold">Alex <span class="red">Wong</span></span>
    <span class="w3-large w3-hide-medium w3-hide-small description">Software and Web Developer</span><br>
	<span class="w3-large"><a href="https://www.linkedin.com/in/alexcwong/" target="_blank"><i class="fab fa-linkedin fa-2x"></i></a></span>
  </div> 
...
<footer class="w3-center w3-black w3-padding-64">
  ...
  <p>&copy; 2020 <a href="index.html">alexcwong.com</a></p>
</footer>
